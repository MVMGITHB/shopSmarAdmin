...
const Brand = () => {
    ...
    const fetchData = async () => {
        try {
            const res = await axios.get(baseurl + "/api/brands/get");

            console.log("----data-----", res.data.brands);
    ...
    const handleDelete = async (record) => {
        try {
            const response = await axios.delete(`${baseurl}/api/brands/delete/${record}`)
            if (response) {
                message.success("Status updated succesfully");
                fetchData();
            }
    ...
    const handlePut = async (values) => {
        ...
        try {
            const response = await axios.put(
                `${baseurl}/api/brands/update/${editingCategory?._id}`,
                postData
            );
            // console.log(response.data);
    ...
    return (
        <div>
            ...
            <Modal
                title={editingCategory ? "Edit Brand" : "Add Brand"}
                open={isModalOpen}
